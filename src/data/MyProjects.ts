...
const MyProjects: Project[] = [
  ...
  },
  {
    ...
    name: "Chat App 💬",
    description:
      "Cross-platform chat Application. Users can join or create live rooms, and chat with their friends online! It supports all the classic emojis, auto notifies when users join/leave the room, and contain a dedicated screen that presents the current users in the room.",
    image: [
      "https://user-images.githubusercontent.com/97472180/178511493-91d1e17a-3203-4f45-b74c-eb87b28b019b.PNG",
      "https://user-images.githubusercontent.com/97472180/191557958-d28c9db2-dc75-4e8b-a4f9-bf31f71633b3.gif",
    ],
    tools: ["React", "Router", "Node.js", "Express", "Socket-IO"],
    links: [
      "https://github.com/YanivWein24/Chat-App-Socket-IO",
      "https://chat-app-faoy.onrender.com/",
    ],
  },
  {
    id: 2,
    name: "IP Tracker 🌎",
    description:
      "A tracking app that locates users by their IP address. Can locate any valid IPv4 address on the globe! Using 3 different APIs: to find the local IP (optional), track its location, and display it on a live map!",
    image: [
