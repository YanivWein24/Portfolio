...
const Header: FC = () => {
    ...
    return (
        <div className="header" style={{
            backgroundColor: (smallScreen ? '#000000e6' : scroll ? "#000000e6" : 'transparent'),
            borderBottom: (smallScreen ? '5px solid #1c72ff' : scroll ? "5px solid #1c72ff" : 'transparent'),
        }}>
                ...
                <Container>
                    ...
                    <Navbar.Collapse id="basic-navbar-nav" className="justify-content-center">
                        <Nav className="me-auto ">  {/*me-auto - to center */}
                            <div className="linkContainer" style={{ borderRadius: smallScreen ? "10px" : scroll ? "10px" : '0 0 10px 10px' }}
                                ...
                                <Link to="About" smooth={true} duration={1000} offset={-500} className="link"
                                    style={{ color: ((smallScreen || hoverAbout) ? "#fff" : scroll ? '#ccc' : '#fff') }}>
                                    <i className="fa-solid fa-address-card"></i> About</Link></div>
                            <div className="linkContainer" style={{ borderRadius: smallScreen ? "10px" : scroll ? "10px" : '0 0 10px 10px' }}
                                onMouseOver={() => setHoverSkills(true)}
                                onMouseOut={() => setHoverSkills(false)}>
                                <Link to="Skills" smooth={true} duration={750} offset={-70} className="link"
                                    style={{ color: ((smallScreen || hoverSkills) ? "#fff" : scroll ? '#ccc' : '#fff') }}>
                                    <i className="fa-solid fa-bars-progress"></i> Skills</Link></div>
                            <div className="linkContainer" style={{ borderRadius: smallScreen ? "10px" : scroll ? "10px" : '0 0 10px 10px' }}
                                onMouseOver={() => setHoverProjects(true)}
                                onMouseOut={() => setHoverProjects(false)}>
                                <Link to="Projects" smooth={true} duration={750} offset={-20} className="link"
                                    style={{ color: ((smallScreen || hoverProjects) ? "#fff" : scroll ? '#ccc' : '#fff') }}>
                                    <i className="fa-solid fa-code"></i> Projects</Link></div>
                            <div className="linkContainer" style={{ borderRadius: smallScreen ? "10px" : scroll ? "10px" : '0 0 10px 10px' }}
                                ...
                                <Link to="Contact" smooth={true} duration={750} offset={-60} className="link" href="#Contact-me"
                                    style={{ color: ((smallScreen || hoverContact) ? "#fff" : scroll ? '#ccc' : '#fff') }}>
