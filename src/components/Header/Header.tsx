                ...
                <Container>
                    ...
                    <Navbar.Collapse id="basic-navbar-nav" className="justify-content-center">
                        <Nav className="me-auto ">
                            ...
                            <Nav.Link><Link to="Skills" smooth={true} duration={500} className="link" href="#Projects"><i className="fa-solid fa-code"></i> Projects</Link></Nav.Link>
                            ...
                            <Nav.Link><Link to="Skills" smooth={true} duration={500} className="link" href="../Resume Template.pdf" download><i className="fa-solid fa-file"></i> Resume</Link></Nav.Link>
                        </Nav>
